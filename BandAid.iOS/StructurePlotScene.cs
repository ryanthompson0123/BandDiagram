...
//
//        private List<PlotView> plotNodes;
//        private PlotView currentPlotNode;
//        private AxisView primaryYAxisNode;
//        private AxisView xAxisNode;
//
...
//        }
//
//        public GraphView PlotView
//        {
//            get { return (GraphView)View; }
//        }
//
...
//
//                PlotView oldCurrentPlotNode = null;
//                if (plotNodes != null)
//                {
...
//            }
//
//            primaryYAxisNode = new AxisView(ViewModel.PrimaryYAxis, PrimaryYAxisSize);
...
//            }
//
//            xAxisNode = new AxisView(ViewModel.XAxis, XAxisSize);
//            xAxisNode.Position = new CGPoint(LeftYAxisMargin, 0);
//            AddChild(xAxisNode);
//        }
//
//        private PlotView CreatePlotNode(PlotViewModel viewModel)
//        {
//            return new PlotView(viewModel, PlotSize)
//            {
